...
ARCHITECTURE ExpandKeys_architecture OF ExpandKeys IS
  ...
  type state is array (7 downto 0) of std_logic_vector(31 downto 0);
  type outputState is (init, firstfourtoseven, zerotothree, fourtoseven);
  variable word: state;
    ...
    if(start = '1') and (waitfor1clk = false)then
	  case states is
	    when init =>
          ...
          rcon :=  x"01000000";
          prevWord := word(0);
          states := firstfourtoseven;
	      Key_I <= word(0) & word(1) & word(2) & word(3);
	    when firstfourtoseven =>
