...
KeyExpansion : process(clk, nrst)
  type state is array (5 downto 0) of std_logic_vector(31 downto 0);
  variable word: state;
  ...
  for i in 5 downto 0 loop
    ...
    if(start = '1') and (waitfor1clk=false)then
      ...
      waitfor1clk := true;	
      -- Key_I <= word(0) & word(1) & word(2) & word(3) & word(4) & word(5);
	        Key_I <= word(0) & word(5) & rcon & prevWord & word(3) & word(4) & ;
    else
	waitfor1clk := false;
    end if;
  end if; 
